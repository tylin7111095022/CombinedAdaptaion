...
class Teacher_UNet(nn.Module):
    def __init__(self, n_channels, n_classes, is_normalize:bool, bilinear=False, is_cls:bool=True,instance_branch:bool=False,pad_mode:bool=True):
        super(Teacher_UNet, self).__init__()
...
class Student_UNet(nn.Module):
    def __init__(self, n_channels, n_classes, is_normalize:bool, bilinear=False, is_cls:bool=True,instance_branch:bool=False,pad_mode:bool=True):
        super(Student_UNet, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
        self.is_cls = is_cls
...
if __name__ == "__main__":
    teacher = Teacher_UNet(n_channels=1,n_classes=2,is_normalize=True,is_cls=True,pad_mode=False,instance_branch=False)
    student = Student_UNet(n_channels=1,n_classes=2,is_normalize=True,is_cls=True,pad_mode=False,instance_branch=False)
    ...
    student_name_parameters = { param[0]:param[1].data.detach() for param in student.named_parameters()}
    teacher_name_parameters = { param[0]:param[1].data.detach() for param in teacher.named_parameters()}
    c = 0
    with torch.no_grad():
    ...
    # print(teacher_name_parameters.keys())
    # print("="*100)
    # print(student_name_parameters.keys())
                
    print(len(teacher_name_parameters.keys()))
    print(len(student_name_parameters.keys()))
    print(c)